...
namespace K12.Sports.FitnessImportExport
{
    ...
    class SuperComparison
    {
        ...
        public Dictionary<int, Dictionary<int, string>> Boy_仰臥捲腹 { get; set; }
        public Dictionary<int, Dictionary<int, string>> Girl_仰臥捲腹 { get; set; }

        public Dictionary<int, Dictionary<int, string>> Boy_漸速耐力跑 { get; set; }
        public Dictionary<int, Dictionary<int, string>> Girl_漸速耐力跑 { get; set; }
        ...
        public SuperComparison(XmlElement xml)
        {
            ...
            XmlElement Xml_Boy5 = (XmlElement)xml.SelectSingleNode("boy/仰臥捲腹");
            Boy_仰臥捲腹 = GetParse(Xml_Boy5, true);

            XmlElement Xml_Girl5 = (XmlElement)xml.SelectSingleNode("girl/仰臥捲腹");
            Girl_仰臥捲腹 = GetParse(Xml_Girl5, true);

            XmlElement Xml_Boy6 = (XmlElement)xml.SelectSingleNode("boy/漸速耐力跑");
            Boy_漸速耐力跑 = GetParse(Xml_Boy6, true);

            XmlElement Xml_Girl6 = (XmlElement)xml.SelectSingleNode("girl/漸速耐力跑");
            Girl_漸速耐力跑 = GetParse(Xml_Girl6, true);
